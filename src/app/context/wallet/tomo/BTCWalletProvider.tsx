...
import { btcDefaultContext } from "../constants";
import { BTCWalletContext as BTCWalletContextProps } from "../types";

import { useWalletConnection } from "./Provider";

export const BTCWalletContext =
  createContext<BTCWalletContextProps>(btcDefaultContext);
