...
export const network =
  (process.env.NEXT_PUBLIC_STAKING_SDK_BABYLON_NETWORK as Network) || Network.SIGNET;
...
const mainnetConfig: NetworkConfig = {
  ...
  coinSymbol: "BTC",
  networkName: "BTC",
  mempoolApiUrl: `${process.env.NEXT_PUBLIC_STAKING_SDK_BABYLON_MEMPOOL_API}`,
...
const signetConfig: NetworkConfig = {
  ...
  mempoolApiUrl: `${process.env.NEXT_PUBLIC_STAKING_SDK_BABYLON_MEMPOOL_API}/signet`,
...
const testnetConfig: NetworkConfig = {
  ...
  mempoolApiUrl: `${process.env.NEXT_PUBLIC_STAKING_SDK_BABYLON_MEMPOOL_API}/testnet`,
