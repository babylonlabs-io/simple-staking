    ...
    const errorDetails = JSON.stringify(
      {
        ...
        ...(error.userPublicKey && { userPublicKey: error.userPublicKey }),
        ...(error.babylonAddress && { babylonAddress: error.babylonAddress }),
        ...(error.stakingTxHash && { stakingTxHash: error.stakingTxHash }),
        ...(error.btcAddress && { btcAddress: error.btcAddress }),
      },
      null,
      2,
    );
