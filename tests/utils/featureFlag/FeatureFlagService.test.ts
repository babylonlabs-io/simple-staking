...
describe("FeatureFlagService", () => {
  ...
  describe("IsPhase3Enabled", () => {
    it("should return false when FF_PHASE_3 is not set", () => {
      expect(FeatureFlagService.IsPhase3Enabled).toBe(false);
    });

    it('should return false when FF_PHASE_3 is set to "false"', () => {
      process.env.FF_PHASE_3 = "false";
      expect(FeatureFlagService.IsPhase3Enabled).toBe(false);
    });

    it('should return true when FF_PHASE_3 is set to "true"', () => {
      process.env.FF_PHASE_3 = "true";
